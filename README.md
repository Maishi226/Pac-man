...
> 📢 **Current Status: Beta Testing (Demo Available)** > The game is fully playable! However, the project is currently in an experimental phase as we validate a core hypothesis: **Do ghosts driven by ML actually become smarter and more challenging than traditional AI?** Play the demo and let us know your thoughts!
...
* **Motivation Prediction:** The ghosts estimate whether the player is currently in a "greedy state" (focusing on collecting dots) or a "panic state" (rushing towards safety/exits).
